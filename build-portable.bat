...
echo [3/5] Copying and renaming JAR to %JAR_NAME%...
...
if "%MODULES%"=="" set MODULES=java.base,java.desktop
...
echo [5/5] Creating launcher scripts and README...
(
    echo @echo off
    echo runtime\bin\java.exe -jar %JAR_NAME% %%*
) > "%BUILD_DIR%\jnote.bat"
...
(
    ...
    echo.
    echo No Java installation required - JNote includes its own runtime!
